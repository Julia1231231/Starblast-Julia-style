(function (root, factory) {
    ...
    function anchorOverlayToCanvas() {
        ...
        if (needWrap) {
            ...
            Object.assign(wrap.style, { position: 'relative', display: 'inline-block', width: cs.width, height: cs.height, lineHeight: '0', pointerEvents: 'none' });
            if (canvas.parentNode) canvas.parentNode.insertBefore(wrap, canvas);
            wrap.appendChild(canvas);
        }

        if (wrap.parentElement !== frame) {
